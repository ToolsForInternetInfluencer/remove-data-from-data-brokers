...
{
    public partial class CompanyIntroData : Form
    {
        public CompanyIntroData()
        {
            InitializeComponent();
        }
            ...
            if (selectedCellCount > 0)
            {
                ...
                else
                {
                 ...
                 //   sb.Append("Total: " + selectedCellCount.ToString());
                    ...
                    CompanyIntroForm showDetail = new CompanyIntroForm(Int32.Parse(dataGridViewData.SelectedCells[0].Value.ToString()));
                    showDetail.Show();
                }
